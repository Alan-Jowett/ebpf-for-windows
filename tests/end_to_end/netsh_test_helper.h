...
// All test cases now only include native execution
#define DECLARE_ALL_TEST_CASES(_name, _group, _function) DECLARE_NATIVE_TEST(_name, _group, _function)

#define DECLARE_JIT_TEST_CASES(_name, _group, _function) DECLARE_NATIVE_TEST(_name, _group, _function)

...
#line 38 "sample/undocked/tail_call_same_section.c"
    r1 = r0;
    // EBPF_OP_MOV_IMM pc=8 dst=r0 src=r0 offset=0 imm=7
...
#line 41 "sample/undocked/tail_call_same_section.c"
    ...
    // EBPF_OP_MOV_IMM pc=10 dst=r0 src=r0 offset=0 imm=42
#line 41 "sample/undocked/tail_call_same_section.c"
    r0 = IMMEDIATE(42);
#line 41 "sample/undocked/tail_call_same_section.c"
    r0 &= UINT32_MAX;
...
#line 38 "sample/undocked/tail_call_same_section.c"
    ...
    // EBPF_OP_MOV_IMM pc=4 dst=r3 src=r0 offset=0 imm=9
#line 38 "sample/undocked/tail_call_same_section.c"
    r3 = IMMEDIATE(9);
#line 38 "sample/undocked/tail_call_same_section.c"
    r3 &= UINT32_MAX;
...
#line 42 "sample/undocked/tail_call_same_section.c"
    ...
    // EBPF_OP_MOV_IMM pc=12 dst=r1 src=r0 offset=0 imm=1
#line 42 "sample/undocked/tail_call_same_section.c"
    r1 = IMMEDIATE(1);
#line 42 "sample/undocked/tail_call_same_section.c"
    r1 &= UINT32_MAX;
...
label_1:
    // EBPF_OP_MOV_IMM pc=14 dst=r0 src=r0 offset=0 imm=6

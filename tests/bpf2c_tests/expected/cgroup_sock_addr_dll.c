...
static helper_function_entry_t authorize_auth_connect4_helpers[] = {
    {
...
static GUID authorize_auth_connect4_program_type_guid = {
    0x92ec8e39, 0xaeec, 0x11ec, {0x9a, 0x30, 0x18, 0x60, 0x24, 0x89, 0xbe, 0xee}};
static GUID authorize_auth_connect4_attach_type_guid = {
    0x6076c13a, 0xf04f, 0x4ff8, {0x83, 0x80, 0x90, 0x85, 0x53, 0xf2, 0x22, 0x76}};
static uint16_t authorize_auth_connect4_maps[] = {
    0,
    2,
};
...
static uint64_t
authorize_auth_connect4(void* context, const program_runtime_context_t* runtime_context)
#line 111 "sample/cgroup_sock_addr.c"
{
#line 111 "sample/cgroup_sock_addr.c"
    // Prologue.
#line 111 "sample/cgroup_sock_addr.c"
...
#line 54 "sample/cgroup_sock_addr.c"
    WRITE_ONCE_32(r10, (uint32_t)r2, OFFSET(-44));
...
#line 56 "sample/cgroup_sock_addr.c"
    WRITE_ONCE_32(r10, (uint32_t)r2, OFFSET(-24));
...
#line 113 "sample/cgroup_sock_addr.c"
    return r0;
#line 111 "sample/cgroup_sock_addr.c"
}
#pragma code_seg(pop)
...
static helper_function_entry_t authorize_auth_connect6_helpers[] = {
    {
     {1, 40, 40}, // Version header.
     26,
     "helper_id_26",
...
static GUID authorize_auth_connect6_program_type_guid = {
    0x92ec8e39, 0xaeec, 0x11ec, {0x9a, 0x30, 0x18, 0x60, 0x24, 0x89, 0xbe, 0xee}};
static GUID authorize_auth_connect6_attach_type_guid = {
    0x54b0b6ed, 0x432a, 0x4674, {0x8b, 0x27, 0x8d, 0x9f, 0x5b, 0x40, 0xc6, 0x75}};
static uint16_t authorize_auth_connect6_maps[] = {
    0,
    2,
};
...
static uint64_t
authorize_auth_connect6(void* context, const program_runtime_context_t* runtime_context)
#line 118 "sample/cgroup_sock_addr.c"
{
#line 118 "sample/cgroup_sock_addr.c"
    // Prologue.
#line 118 "sample/cgroup_sock_addr.c"
...
#line 120 "sample/cgroup_sock_addr.c"
    return r0;
#line 118 "sample/cgroup_sock_addr.c"
}
#pragma code_seg(pop)
...
static program_entry_t _programs[] = {
    {
        ...
        authorize_auth_connect4,
        "cgroup~2",
        "cgroup/auth_connect4",
        "authorize_auth_connect4",
        authorize_auth_connect4_maps,
        2,
        authorize_auth_connect4_helpers,
        3,
        34,
        &authorize_auth_connect4_program_type_guid,
        &authorize_auth_connect4_attach_type_guid,
    },
    {
        0,
        {1, 144, 144}, // Version header.
        authorize_auth_connect6,
        "cgroup~1",
        "cgroup/auth_connect6",
        "authorize_auth_connect6",
        authorize_auth_connect6_maps,
        2,
        authorize_auth_connect6_helpers,
        3,
        40,
        &authorize_auth_connect6_program_type_guid,
        &authorize_auth_connect6_attach_type_guid,
    },
    {
        0,
        {1, 144, 144}, // Version header.

...
// This file was generated from thread_start_time.o
...
#define metadata_table thread_start_time##_metadata_table
...
metadata_table_t thread_start_time_metadata_table = {
